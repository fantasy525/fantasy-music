...
Sound.prototype.release = function() {
  if (this._loaded) {
    ...
    if (!IsWindows) {
      ...
      if(this._bufferUpdateListener!==null){
      	this._bufferUpdateListener.remove();
      	this._bufferUpdateListener=null;
			}
    }
  }
  return this;
...
Sound.prototype.getBufferingUpdate=function(callback){
	if(this._key===null) return
	RNSound.getBufferingUpdate(this._key)
	this._bufferUpdateListener=DeviceEventEmitter.addListener("onBufferingUpdate",function (progress) {
		callback(progress)
	})
}
